...
_recipes_pil_prescript(['IcnsImagePlugin', 'GbrImagePlugin', 'DdsImagePlugin', 'WebPImagePlugin', 'FliImagePlugin', 'DcxImagePlugin', 'PcxImagePlugin', 'QoiImagePlugin', 'GribStubImagePlugin', 'MicImagePlugin', 'FtexImagePlugin', 'MspImagePlugin', 'ImImagePlugin', 'Hdf5StubImagePlugin', 'JpegImagePlugin', 'Jpeg2KImagePlugin', 'ImtImagePlugin', 'McIdasImagePlugin', 'PngImagePlugin', 'TiffImagePlugin', 'PsdImagePlugin', 'XVThumbImagePlugin', 'SgiImagePlugin', 'IcoImagePlugin', 'PixarImagePlugin', 'PdfImagePlugin', 'FpxImagePlugin', 'GifImagePlugin', 'TgaImagePlugin', 'WmfImagePlugin', 'BmpImagePlugin', 'CurImagePlugin', 'MpoImagePlugin', 'FitsImagePlugin', 'XpmImagePlugin', 'PcdImagePlugin', 'SunImagePlugin', 'PpmImagePlugin', 'EpsImagePlugin', 'PalmImagePlugin', 'MpegImagePlugin', 'BufrStubImagePlugin', 'BlpImagePlugin', 'IptcImagePlugin', 'XbmImagePlugin', 'SpiderImagePlugin'])
